...
var cote = 40;
	...
	x = (X-cote)/2 ; y = (Y - cote)/2 ; // pour centrer le pavé dans canvas
	contexte.fillRect(x,y,cote,cote);
	document.onkeydown = clavier_lire; 	
	// appel de la fonction clavier_lire si utilisateur appuie sur une touche du clavier 
